...
interface Props {
  ...
  next?: any;
  onLoad?: (self: any, name: string) => void;
}
...
export const InputField = ({
  ...
  const autoCapitalize = (
    textTransform: undefined | 'none' | 'sentences' | 'words' | 'characters',
  ) => {
    return textTransform;
  };

  useEffect(() => {
    onLoad && onLoad(thisRef, name);
  }, []);
    ...
    <View
      ...
      <View
        ...
        <TextInput
          ...
          autoCapitalize={autoCapitalize(textTransform)}
        />
      ...
      </View>
      {
        ...
        showError &&
          ...
          Platform.select({
            ...
            native: (
              <Text style={[styles.textError, {marginVertical: 5}]}>
                {errorToDisplay}
              </Text>
            ),
          })
