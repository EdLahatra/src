...
export const MessageListMobile = <T extends {}>(
  props: FlatListProps<T> & {innerRef?: React.RefObject<FlatList<T>>},
) => {
  ...
  return (
    <FlatList {...panResponder.panHandlers} {...props} ref={props.innerRef} />
  );
};
